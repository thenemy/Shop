...
<div x-data="{ open: false }" class="cursor-pointer">
    ...
    <div
        class="@if($item->isCurrentRoute()) bg-blue-400 rounded-md @endif flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
        <div>
